    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4 py-8">
      <div className="max-w-2xl text-center w-full">
        ...
        <div className="mt-6 p-4 bg-slate-900 text-red-400 text-xs font-mono text-left rounded-lg overflow-auto max-h-[300px] border border-red-500/20 shadow-inner">
          ...
          {error.stack && (
            <pre className="whitespace-pre-wrap text-[10px] text-slate-300 leading-normal">
              {error.stack}
            </pre>
          )}
        </div>
  ...
  head: () => ({
    meta: [
      ...
      { title: "Cascade Tech Ventures — Salesforce & AI Voice Innovation" },
      {
        name: "description",
        content:
          "A cinematic 3D presentation experience by Cascade Tech Ventures — strategic Salesforce solutions and next-generation AI voice technology.",
      },
      { name: "author", content: "Cascade Tech Ventures" },
      {
        property: "og:title",
      ...
      },
      {
        ...
        content:
          "Travel through a futuristic Salesforce-powered business city. Strategic CRM solutions and AI voice technology by Cascade Tech.",
      },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:site", content: "@CascadeTech" },
