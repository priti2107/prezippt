    ...
    >
      ...
      <div className="flex flex-col items-center text-center w-full flex-shrink-0 z-20 gap-3">
        <div className="flex flex-col items-center">
          ...
          <p className="mt-2.5 text-[14px] md:text-[16px] text-slate-500 font-medium leading-relaxed max-w-none">
              ...
              <div className="flex-1 min-h-0 rounded-[16px] overflow-hidden relative flex items-center justify-center"
                ...
                <svg viewBox="0 0 540 395" className="w-full h-full" xmlns="http://www.w3.org/2000/svg" style={{ maxHeight: "100%" }}>
                  ...
                  <g className="transition-transform duration-300 hover:scale-[1.02] origin-[270px_101px] cursor-pointer cc-node-2">
                    ...
                    <image href="/clients/casecadeconnect.png" x="153" y="80" width="42" height="42" />
                  ...
                  <g className="transition-transform duration-300 hover:scale-[1.02] origin-[95px_166px] cursor-pointer cc-node-3-1">
                    ...
                    <text x="115" y="171" fontSize="15" fontWeight="700" fill="#0F172A" textAnchor="middle">WhatsApp</text>
                  </g>
                  ...
                  <g className="transition-transform duration-300 hover:scale-[1.02] origin-[270px_166px] cursor-pointer cc-node-3-2">
                    ...
                    <text x="290" y="171" fontSize="15" fontWeight="700" fill="#0F172A" textAnchor="middle">Gmail</text>
                  </g>
                  ...
                  <g className="transition-transform duration-300 hover:scale-[1.02] origin-[445px_166px] cursor-pointer cc-node-3-3">
                    ...
                    <text x="465" y="171" fontSize="15" fontWeight="700" fill="#0F172A" textAnchor="middle">SMS</text>
                  </g>
              ...
              <div className="flex-1 min-h-0 rounded-[16px] overflow-hidden relative flex items-center justify-center"
                ...
                <svg viewBox="0 0 540 350" className="w-full h-full" xmlns="http://www.w3.org/2000/svg" style={{ maxHeight: "100%" }}>
                  ...
                  <g className="transition-transform duration-300 hover:scale-[1.02] origin-[270px_220px] cursor-pointer prism-node-engine">
                    ...
                    {/* CX Prism Logo Image */}
                    <image href="/clients/cxprism.png" x="153" y="199" width="42" height="42" />
                  ...
                  <g className="transition-transform duration-300 hover:scale-[1.02] origin-[270px_311px] cursor-pointer prism-node-out">
                    ...
                    <text x="285" y="316" fontSize="14.5" fontWeight="700" fill="#0F172A" textAnchor="middle">Sales CRM</text>
                  </g>
                  ...
                  <g className="transition-transform duration-300 hover:scale-[1.02] origin-[452.5px_311px] cursor-pointer prism-node-out">
                    ...
                    <text x="467" y="316" fontSize="14.5" fontWeight="700" fill="#0F172A" textAnchor="middle">Management</text>
                  </g>
                </svg>
              </div>
